...
namespace Idfy.Signature.Models.Signers
{
    public class Signer
    {
        ...
        /// <summary>
        /// How long before the signers url should expire? The format is unix time (UTC). This can be set if you only want a limited time to live for each sign url (If you generate a new url at a later time this will also have this limited lifetime). Defaults to the document lifetime.
        /// </summary>
